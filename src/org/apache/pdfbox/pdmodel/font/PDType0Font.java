...
public class PDType0Font extends PDFont implements PDVectorFont
{
	...
	// begin modification by Tamir Hassan
	// would be good to include this method in a pull request
	// for now, this field is accessed using reflection instead, to remove
	// dependency on altered code
    ...
    public KerningTable getKerningTable()
    {
    	...
    	return null; // TODO exception call
    }
