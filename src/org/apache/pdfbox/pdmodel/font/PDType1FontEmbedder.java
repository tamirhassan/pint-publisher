...
class PDType1FontEmbedder
{
                        ...
                        Encoding encoding) throws IOException
    {
        ...
        System.out.println(type1.getName() + " ä-width: " + type1.getWidth("adieresis"));
        
//        type1.
        
        for (Object o : type1.getCharStringsDict().keySet())
        {
        	System.out.println("dict: " + o);
        }
        Object o2 = type1.getCharStringsDict().get("adieresis");
        ...
        if (encoding == null)
        {
            ...
            for (Object o : fontEncoding.getNameToCodeMap().keySet())
            {
            	System.out.println("enc: " + o);
            }
        }
        else
        {
        ...
        System.out.println("ä is: " + fontEncoding.getNameToCodeMap().get("adieresis"));
