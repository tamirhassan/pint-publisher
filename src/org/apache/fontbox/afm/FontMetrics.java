...
public class FontMetrics
{
    ...
    // 2018-02-15 start modification by Tamir Hassan
    
    public float getKerningAdjustment( String name1, String name2 )
	{
		for (KernPair kp : kernPairs)
		{
			if (name1.equals(kp.getFirstKernCharacter())
					&& name2.equals(kp.getSecondKernCharacter()))
			{
				return kp.getX(); // Y-kerning is ignored for now
			}
		}
		return 0.0f; // no kernpair found
	}
    
    // 2018-02-15 end modification by Tamir Hassan
