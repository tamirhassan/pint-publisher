 ...
 */
package com.tamirhassan.publisher.pdmodel;
 ...
 */
public final class PDBinaryContentStream implements Closeable
{
     ...
     */
    public PDBinaryContentStream(PDDocument document, PDPage sourcePage) throws IOException
    {
     ...
     */
    @Deprecated
    public PDBinaryContentStream(PDDocument document, PDPage sourcePage, boolean appendContent,
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDBinaryContentStream(PDDocument document, PDPage sourcePage, AppendMode appendContent,
                               boolean compress) throws IOException
    {
        this(document, sourcePage, appendContent, compress, false);
    }
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDBinaryContentStream(PDDocument doc, PDAppearanceStream appearance) throws IOException
    {
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDBinaryContentStream(PDDocument doc, PDAppearanceStream appearance, OutputStream outputStream)
            throws IOException
    {
        this.document = doc;
